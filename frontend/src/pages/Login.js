              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-slate-200 px-4 py-2 pr-10 text-sm focus:border-slate-900 focus:ring-1 focus:ring-slate-900 outline-none transition-all bg-white"
